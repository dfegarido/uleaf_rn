...
// Values are in USD
import { REFUNDABLE_AIR_CARGO_DOCUMENTATION_FEE } from './shippingConstants';

const airDocFee = REFUNDABLE_AIR_CARGO_DOCUMENTATION_FEE;
const singleGrowerRule = {base: 50, addOn: 5, airBase: airDocFee, airAddOn: 0};

const shippingRules = {
  // Single plant uses height buckets (<=12in or >12in)
  single: {
    '<=12': {...singleGrowerRule},
    '>12': {base: 70, addOn: 5, airBase: airDocFee, airAddOn: 0},
    default: {...singleGrowerRule},
  },
  ...
  growers: {
    '<=4': {...singleGrowerRule},
    '>4': {base: 70, addOn: 8, airBase: airDocFee, airAddOn: 0},
    default: {...singleGrowerRule},
  },
