...
import styles from './styles/CancelRequestModalStyles';

/**
 * CancelRequestModal - Confirmation modal for canceling a receiver request
 */
          ...
          <Pressable onPress={(e) => e.stopPropagation()}>
            <View style={styles.popover}>
              <View style={styles.textContainer}>
                <Text style={styles.titleText}>Confirm cancel request</Text>
              </View>
            </View>
