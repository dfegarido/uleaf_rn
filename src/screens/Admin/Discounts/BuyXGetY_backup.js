...
const AmountOffPlantsPercentage = () => {
              ...
              <View style={[styles.typeSheetContainer, {position: 'absolute', left: (SCREEN.width - 340) / 2, top: typeSheetTop}] }>
                <View style={styles.typeRowWrapper}>
                  <TouchableOpacity style={styles.typeRowLeft} onPress={() => { 
                    ...
                    navigation.replace('AdminDiscountAmountOffPlantsPercentage');
                  }}>
                    <Svg width={24} height={24} viewBox="0 0 24 24" fill="none">
                ...
                <View style={styles.typeRowWrapper}>
                  <TouchableOpacity style={styles.typeRowLeft} onPress={() => { 
                    ...
                    setShowTypeSheet(false); 
                    navigation.replace('AdminDiscountAmountOffPlantsPercentage', { mode: 'fixed' });
                  }}>
                    <Svg width={24} height={24} viewBox="0 0 24 24" fill="none">
...
export default AmountOffPlantsPercentage;
