      ...
      <View style={styles.detailsContainer}>
        <View style={styles.flightDetailsRow}>
          ...
          <Text style={styles.detailsText}>
            Plant Flight <Text style={{ fontWeight: 'bold' }}>{moment(item.flightDate).isValid() ? moment(item?.flightDate?._seconds ? (item.flightDate._seconds * 1000) : item?.flightDate).format('MMM DD, YYYY') : item.flightDate}</Text>
          </Text>
        </View>
