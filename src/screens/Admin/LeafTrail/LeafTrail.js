  ...
  return (
    <View style={styles.headerContainer}>
      ...
      <TouchableOpacity activeOpacity={0.5} style={styles.roleChip} onPress={onPressRole}>
        <Text style={styles.roleTextDropdown}>Admin Role</Text>
      ...
      <View style={styles.modalOverlay}>
        ...
        >
          <View style={styles.sheetHeader}>
            <Text style={styles.sheetTitle}>Admin Roles</Text>
...
const LeafTrail = () => {
  ...
  const [roles, setRoles] = useState([
    { key: 'super_admin', label: 'Super Admin', selected: true },
    { key: 'greenhouse_manager', label: 'Greenhouse Manager', selected: true },
    { key: 'encoder', label: 'Encoder', selected: true },
  ]);
  ...
  const applyView = () => {
    // TODO: Hook this into filtering logic if needed
