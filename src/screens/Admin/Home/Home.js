  ...
  return (
    <View style={[styles.sectionContainer, {paddingTop: 24}]}>
      ...
      <View style={styles.grid}>
        ...
        <IconTile title="In-Transit" onPress={() => navigation.navigate('LeafTrailShippingAdminScreen')}>
          <ForShippingIcon width={48} height={48} />
        </IconTile>
        <IconTile title="Delivered" onPress={() => navigation.navigate('LeafTrailShippedAdminScreen')}> 
    ...
    return (
      <View style={[styles.sectionContainer, {paddingTop: 24}]}>
        ...
        <View style={styles.grid}>
          ...
          <IconTile title="Credit Mgmt" onPress={() => navigation.navigate('PlantCreditsManagement')}>
  ...
  return (
    <SafeAreaView style={{flex: 1, backgroundColor: '#fff'}} edges={['top', 'left', 'right']}>
      ...
      <ScrollView
        ...
        <AppUpdateCard style={{marginHorizontal: 20, marginTop: 16}} />
