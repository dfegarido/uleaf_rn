...
const ScanQRSellerScreen = ({ navigation, route }) => {
      ...
      <SafeAreaView style={styles.screenContainer} edges={['top']}>
        ...
        {buttomData === 'invalid' && (
          <View style={styles.bottomSheet}>
            ...
            <View style={styles.noteContainer}>
              <Text style={styles.noteText}>
                This order is not found. Align the QR Code with the camera.
              </Text>
            </View>
          </View>
        )}
            ...
            <View style={styles.contentInnerContainer}>
              ...
              <View style={styles.detailsSection}>
                <View style={styles.mutationRow}>
                    ...
                    <Text style={styles.mutationText}>Inventory for Hub</Text>
                </View>
                    ...
                    <View style={styles.plantDetails}>
                        <View style={styles.plantNameSection}>
                            <View style={styles.plantCodeCountry}>
                                ...
                                <View style={styles.plantCountryContainer}>
                                    <Text style={styles.plantCountryText}>{plantData.plantSourceCountry}</Text>
                                    <CountryFlagIcon code={plantData.plantSourceCountry} width={24} height={16} />
                                </View>
                            </View>
                        ...
                        <View style={styles.plantTypeQuantity}>
                            <View style={styles.listingTypeChip}>
                                <Text style={styles.listingTypeLabel}>{plantData.listingType}</Text>
                            </View>
                            <Text style={styles.quantityText}>x{plantData.orderQty}</Text>
                        </View>
                    </View>
                </View>
              </View>
...
export default ScanQRSellerScreen;