...
const DeliverTableSkeletonRow = () => {
  return (
    <View style={styles.row}>
      {/* For Delivery (Image with checkbox) */}
...
const DeliverTableSkeleton = ({rowCount = 5}) => {
  return (
    <ScrollView horizontal showsHorizontalScrollIndicator={false}>
      <View>
        ...
        {Array.from({length: rowCount}).map((_, index) => (
          <DeliverTableSkeletonRow key={index} />
        ))}
      </View>
    </ScrollView>
  );
...
export default DeliverTableSkeleton;
